define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'edu/index' + location.search,
                    add_url: 'edu/add',
                    edit_url: 'edu/edit',
                    del_url: 'edu/del',
                    multi_url: 'edu/multi',
                    import_url: 'edu/import',
                    table: 'edu',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'begintime', title: __('Begintime'), operate:'RANGE', addclass:'datetimerange', autocomplete:false},
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'edu/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
